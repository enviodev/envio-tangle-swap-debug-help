...
let getConfig = (chain: ChainMap.Chain.t) =>
  ...
  | Chain_148 => {
      ...
      syncSource: HyperSync("https://shimmer-evm.hypersync.xyz"),
      startBlock: 35196,
      chain: Chain_148,
      contracts: [
        {
          ...
          addresses: [
            "0xdf7bA717FB0D5ce579252f05167cD96d0fA77bCb"->Ethers.getAddressFromStringUnsafe,
          ],
          events: [Factory_PoolCreated],
        },
        {
          name: "NonfungiblePositionManager",
          abi: Abis.nonfungiblePositionManagerAbi->Ethers.makeAbi,
          addresses: [
            "0xbDdbea66383f6A8879701d22B8b45F887123736A"->Ethers.getAddressFromStringUnsafe,
          ],
          events: [
